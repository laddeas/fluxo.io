...
const ConnectorsPage: React.FC = () => {
  ...
  const handleCreate = () => {
    ...
    const newConnector = {
      ...
      icon: type === 'DATABASE' ? '🐘' : type === 'CLOUD_STORAGE' ? '📦' : type === 'FILE_SYSTEM' ? '📁' : '🔗',
      color: type === 'DATABASE' ? '#336791' : type === 'CLOUD_STORAGE' ? '#FF9900' : type === 'FILE_SYSTEM' ? '#10B981' : brand.accent,
      lastTested: 'Just now',
      interfaces: 0,
      hostUrl: type === 'DATABASE' ? dbHost : type === 'FILE_SYSTEM' ? fsRootPath : hostUrl,
      authMethod,
